...
// The pass should insert a single copy + coalesce before each branch.
...
// CHECK-DAG:         %[[PHI:.*]] = alloca : !amdgcn.vgpr<?>
// CHECK:             cf.cond_br %[[CALL_0]], ^bb1, ^bb2
// CHECK:           ^bb1:
// CHECK:             lsir.copy %[[PHI]], %[[VAL_0]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             reg_coalesce %[[PHI]], %[[VAL_0]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             cf.br ^bb3
// CHECK:           ^bb2:
// CHECK:             lsir.copy %[[PHI]], %[[VAL_1]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             reg_coalesce %[[PHI]], %[[VAL_1]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             cf.br ^bb3
// CHECK:           ^bb3:
// CHECK:             %[[VAL_5:.*]] = dealloc_cast %[[PHI]] : !amdgcn.vgpr<?>
...
// CHECK:             cf.br ^bb3
// CHECK:           ^bb3:
// CHECK:             %[[VAL_4:.*]] = dealloc_cast %[[PHI]] : !amdgcn.vgpr<?>
...
// CHECK-DAG:         %[[PHI:.*]] = alloca : !amdgcn.sgpr<?>
// CHECK:             cf.cond_br %[[CALL_0]], ^bb1, ^bb2
// CHECK:           ^bb1:
// CHECK:             lsir.copy %[[PHI]], %[[VAL_0]] : !amdgcn.sgpr<?>, !amdgcn.sgpr
// CHECK:             reg_coalesce %[[PHI]], %[[VAL_0]] : !amdgcn.sgpr<?>, !amdgcn.sgpr
// CHECK:             cf.br ^bb3
// CHECK:           ^bb2:
// CHECK:             lsir.copy %[[PHI]], %[[VAL_1]] : !amdgcn.sgpr<?>, !amdgcn.sgpr
// CHECK:             reg_coalesce %[[PHI]], %[[VAL_1]] : !amdgcn.sgpr<?>, !amdgcn.sgpr
// CHECK:             cf.br ^bb3
// CHECK:           ^bb3:
// CHECK:             %[[VAL_5:.*]] = dealloc_cast %[[PHI]] : !amdgcn.sgpr<?>
...
// The copy source is the instruction result (value semantics), and the coalesce
// targets the underlying alloca (storage).
...
// CHECK:             %[[PHI:.*]] = alloca : !amdgcn.vgpr<?>
// CHECK:             cf.cond_br %[[CALL_0]], ^bb1, ^bb2
// CHECK:           ^bb1:
// CHECK:             lsir.copy %[[PHI]], %[[VAL_3]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             reg_coalesce %[[PHI]], %[[VAL_0]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             cf.br ^bb3
// CHECK:           ^bb2:
// CHECK:             lsir.copy %[[PHI]], %[[VAL_4]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             reg_coalesce %[[PHI]], %[[VAL_1]] : !amdgcn.vgpr<?>, !amdgcn.vgpr
// CHECK:             cf.br ^bb3
// CHECK:           ^bb3:
// CHECK:             %[[VAL_8:.*]] = dealloc_cast %[[PHI]] : !amdgcn.vgpr<?>
