...
// CHECK-LABEL: kernel @sgpr_copy_expands {
...
// CHECK:         end_kernel
amdgcn.module @sgpr_copy_expands_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @vgpr_copy_expands {
...
// CHECK:         end_kernel
amdgcn.module @vgpr_copy_expands_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @agpr_copy_expands {
...
// CHECK:         end_kernel
amdgcn.module @agpr_copy_expands_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @vgpr_range_copy_expands {
...
// CHECK:         end_kernel
amdgcn.module @vgpr_range_copy_expands_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @sgpr_to_vgpr_copy_expands {
// CHECK-DAG:     %[[V0:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK-DAG:     %[[S0:.*]] = alloca : !amdgcn.sgpr<0>
// CHECK:         v_mov_b32 outs(%[[V0]]) ins(%[[S0]]) : outs(!amdgcn.vgpr<0>) ins(!amdgcn.sgpr<0>)
// CHECK:         test_inst ins %[[V0]] : (!amdgcn.vgpr<0>) -> ()
// CHECK:         end_kernel
amdgcn.module @sgpr_to_vgpr_copy_expands_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @vgpr_to_agpr_copy_not_expanded {
// CHECK-DAG:     %[[A0:.*]] = alloca : !amdgcn.agpr<0>
// CHECK-DAG:     %[[V0:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK:         lsir.copy %[[A0]], %[[V0]] : !amdgcn.agpr<0>, !amdgcn.vgpr<0>
// CHECK:         end_kernel
amdgcn.module @vgpr_to_agpr_copy_not_expanded_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @agpr_to_vgpr_copy_not_expanded {
// CHECK-DAG:     %[[V0:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK-DAG:     %[[A0:.*]] = alloca : !amdgcn.agpr<0>
// CHECK:         lsir.copy %[[V0]], %[[A0]] : !amdgcn.vgpr<0>, !amdgcn.agpr<0>
// CHECK:         end_kernel
amdgcn.module @agpr_to_vgpr_copy_not_expanded_mod target = <gfx942> {
