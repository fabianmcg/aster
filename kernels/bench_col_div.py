"""Benchmark for the col_div kernel.

Usage:
    python bench_col_div.py --m M --n N --n_d N_D --rows_per_block RPB
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Benchmark col_div kernel")
    parser.add_argument(
